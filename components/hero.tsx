    ...
    <section className="relative pt-28 pb-24 md:pt-36 md:pb-32">
      <div className="container mx-auto px-4 relative z-10">
        <div className={`flex flex-col lg:flex-row items-center gap-12 transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
          ...
          <div className="flex-1 w-full text-left">
            <div className="space-y-8">
              <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-gray-900 dark:text-white leading-tight">
                Securing Today for
                <span className="block bg-gradient-to-r from-bluelagoon-600 to-bluelagoon-500 dark:from-bluelagoon-400 dark:to-bluelagoon-300 bg-clip-text text-transparent mt-3 lg:mt-4">
                  A Better Tomorrow
                </span>
              </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-5 mt-12">
              <Link href="/contact" className="w-full sm:w-auto">
                <Button className="w-full sm:w-auto bg-gradient-to-r from-bluelagoon-600 to-bluelagoon-500 hover:from-bluelagoon-700 hover:to-bluelagoon-600 text-white px-12 py-7 text-lg sm:text-xl rounded-xl font-semibold transition-all duration-200 hover:shadow-lg hover:shadow-bluelagoon-500/25 hover:scale-[1.02] border border-bluelagoon-500/20">
          ...
          <div className="hidden lg:flex flex-1 items-center justify-center w-full max-w-3xl h-[600px] ml-16">
