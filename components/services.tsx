          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => {
              ...
              return (
                <div
                  key={service.title}
                  className={`bg-green-50 dark:bg-green-900/40 backdrop-blur-sm border border-green-200/50 dark:border-green-800/50 rounded-xl p-8 flex flex-col h-full transition-all duration-300 hover:border-green-500/50 dark:hover:border-green-400/50`}
                >
                  <div className="mb-6">
