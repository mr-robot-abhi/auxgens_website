...
export default function Footer() {
  return (
    <footer className="bg-gray-950/80 backdrop-blur-sm text-white border-t border-gray-800/50">
        ...
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex space-x-4">
              <Link
                href="#"
                className="w-10 h-10 bg-gray-800/80 backdrop-blur-sm rounded-lg flex items-center justify-center hover:bg-green-600/20 hover:border-green-500/50 transition-colors duration-200 border border-gray-700/50"
              >
        ...
        <div className="border-t border-gray-800/50 mt-12 pt-8">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 bg-gradient-to-br from-green-500/20 to-green-600/30 backdrop-blur-sm rounded-lg flex items-center justify-center border border-green-500/20">
                <Mail className="w-5 h-5 text-green-400" />
              </div>
              <div>
                <p className="font-semibold text-white">Email</p>
                <p className="text-sm text-gray-400">security@auxgens.com</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">+1 (555) 911-HELP</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="font-semibold text-white">Global Presence</p>
                <p className="text-sm text-gray-400">Asia US EMEA EU</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">Minutes average</p>
              </div>
            </div>
          </div>
        </div>
