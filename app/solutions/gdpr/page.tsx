...
import { Shield, AlertTriangle, CheckCircle, FileText, Users, Database, Eye, Lock, Server } from "lucide-react"
        ...
        <main className="pt-32 pb-20">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-16">
              ...
              <h1 className="text-4xl sm:text-5xl font-bold text-white mb-6">GDPR Compliance Solutions</h1>
            ...
            <div className="mb-20">
              <div className="bg-gradient-to-br from-blue-500/10 to-green-500/10 backdrop-blur-sm p-12 rounded-2xl border border-blue-500/20">
                <h2 className="text-3xl font-bold text-white text-center mb-8">Understanding GDPR</h2>
                <div className="grid md:grid-cols-2 gap-8">
                  <div>
                    <h3 className="text-xl font-bold text-white mb-4">What is GDPR?</h3>
                ...
                <div className="bg-red-500/10 backdrop-blur-sm border border-red-500/20 rounded-xl p-6 mt-8">
                  <div className="flex items-start space-x-4">
                    <AlertTriangle className="w-8 h-8 text-red-400 mt-1 flex-shrink-0" />
                    <div>
                      <h3 className="font-bold text-red-300 mb-2">Penalty for Non-Compliance</h3>
            ...
            {/* Individual Rights */}
            <div className="mb-20">
              <h2 className="text-3xl font-bold text-white text-center mb-12">Individual Rights Under GDPR</h2>
            ...
            {/* Our GDPR Services */}
            <div className="mb-20">
              <h2 className="text-3xl font-bold text-white text-center mb-12">Our Comprehensive GDPR Services</h2>
            ...
            <div className="mb-20">
              <h2 className="text-3xl font-bold text-white text-center mb-12">GDPR Implementation Areas</h2>
            ...
            <div className="mb-20">
              <div className="bg-gradient-to-br from-green-500/10 to-blue-500/10 backdrop-blur-sm p-12 rounded-2xl border border-green-500/20">
                <h2 className="text-3xl font-bold text-white text-center mb-8">Key Benefits of Our GDPR Services</h2>
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                  {[
                    {
            ...
            <div className="mb-20">
              <h2 className="text-3xl font-bold text-white text-center mb-12">Our GDPR Implementation Methodology</h2>
              <div className="grid md:grid-cols-4 gap-6">
                {[
                  ...
                  <div
                    ...
                    className="bg-gray-900/60 backdrop-blur-sm p-6 rounded-xl shadow-lg border border-gray-700/50 text-center"
                  >
                    <div className="w-12 h-12 bg-green-600/20 backdrop-blur-sm rounded-full flex items-center justify-center mx-auto mb-4 border border-green-500/30">
                      <span className="text-white font-bold">{index + 1}</span>
                    </div>
                    <h3 className="font-bold text-green-400 mb-2">{phase.phase}</h3>
              ...
              <div className="bg-gradient-to-r from-green-600/20 to-green-700/30 backdrop-blur-sm text-white p-12 rounded-2xl border border-green-500/20">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <Link href="/services/dpo">
                    <Button
                      variant="outline"
                      className="border-white/20 text-white hover:bg-white/10 px-8 py-3 text-lg font-medium rounded-lg transition-all duration-200 bg-transparent backdrop-blur-sm"
                    >
