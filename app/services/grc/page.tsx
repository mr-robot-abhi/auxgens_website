        ...
        <main className="pt-32 pb-20">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-16">
              ...
              <h1 className="text-4xl sm:text-5xl font-bold text-white mb-6">GRC Services</h1>
            ...
            <div className="mb-20">
              <div className="bg-gradient-to-br from-blue-500/10 to-green-500/10 backdrop-blur-sm p-12 rounded-2xl border border-blue-500/20">
                <h2 className="text-3xl font-bold text-white text-center mb-8">Understanding GRC</h2>
                <div className="grid md:grid-cols-3 gap-8">
                  ...
                  <div className="text-center">
                    ...
                    <h3 className="text-xl font-bold text-white mb-2">Risk</h3>
                    <p className="text-gray-300">
            ...
            <div className="mb-20">
              <div className="bg-gradient-to-br from-green-500/10 to-blue-500/10 backdrop-blur-sm p-12 rounded-2xl border border-green-500/20">
                <h2 className="text-3xl font-bold text-white text-center mb-8">How Auxgens Can Help</h2>
            ...
            {/* Our Services */}
            <div className="mb-20">
              <h2 className="text-3xl font-bold text-white text-center mb-12">Our Comprehensive GRC Services</h2>
            ...
            <div className="mb-20">
              <h2 className="text-3xl font-bold text-white text-center mb-12">GRC Framework Components</h2>
            ...
            {/* Benefits */}
            <div className="mb-20">
              <h2 className="text-3xl font-bold text-white text-center mb-12">Benefits of Our GRC Services</h2>
              <div className="grid md:grid-cols-2 gap-8">
                {[
                  {
