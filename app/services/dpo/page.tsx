        ...
        <main className="pt-32 pb-20">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-16">
              ...
              <h1 className="text-4xl sm:text-5xl font-bold text-white mb-6">DPO as a Service</h1>
            ...
            <div className="mb-20">
              <div className="bg-gradient-to-br from-blue-500/10 to-green-500/10 backdrop-blur-sm p-12 rounded-2xl border border-blue-500/20">
                <h2 className="text-3xl font-bold text-white text-center mb-8">What is a Data Protection Officer?</h2>
            ...
            {/* DPO Benefits */}
            <div className="mb-20">
              <h2 className="text-3xl font-bold text-white text-center mb-12">DPO as a Service Benefits</h2>
            ...
            {/* Key Services */}
            <div className="mb-20">
              <h2 className="text-3xl font-bold text-white text-center mb-12">Key DPO Services</h2>
            ...
            <div className="mb-20">
              <div className="bg-gradient-to-br from-green-500/10 to-blue-500/10 backdrop-blur-sm p-12 rounded-2xl border border-green-500/20">
                <h2 className="text-3xl font-bold text-white text-center mb-8">Why Choose Our DPO Service?</h2>
            ...
            <div className="mb-20">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                  ...
                  <div
                    key={index}
                    className="bg-gradient-to-br from-blue-500/10 to-blue-600/20 backdrop-blur-sm p-6 rounded-xl text-center border border-blue-500/20"
                  >
