        ...
        <section className="py-16">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-16">
              {/* Contact Form */}
              <div className="bg-white/80 dark:bg-gray-900/60 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-gray-200 dark:border-gray-700/50">
              ...
              <div className="space-y-8">
                ...
                <div className="bg-white/80 dark:bg-gray-900/60 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-gray-200 dark:border-gray-700/50">
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start space-x-4">
                      <div className="w-12 h-12 bg-gradient-to-br from-green-500/20 to-green-600/30 dark:from-green-500/20 dark:to-green-600/30 backdrop-blur-sm rounded-lg flex items-center justify-center flex-shrink-0 border border-green-500/20">
                        <Mail className="w-6 h-6 text-green-600 dark:text-green-400" />
                      </div>
                      <div>
                        <h4 className="font-semibold text-gray-900 dark:text-white">Email</h4>
                        <p className="text-gray-700 dark:text-gray-300">security@auxgens.com</p>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700 dark:text-gray-300">+1 (555) 911-HELP</p>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700 dark:text-gray-300">Asia Pacific • United States</p>
                        <p className="text-gray-700 dark:text-gray-300">Europe, Middle East, Africa • European Union</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700 dark:text-gray-300">{"<15 minutes average"}</p>
                ...
                {/* Why Choose Us */}
                <div className="bg-white/80 dark:bg-gray-900/60 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-gray-200 dark:border-gray-700/50">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Why Choose Auxgens?</h3>
                  <div className="space-y-4">
                    <div className="flex items-center space-x-3">
                      <Shield className="w-6 h-6 text-green-600 dark:text-green-400" />
                      <span className="text-gray-700 dark:text-gray-300">Industry-leading security expertise</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <Users className="w-6 h-6 text-green-600 dark:text-green-400" />
                      <span className="text-gray-700 dark:text-gray-300">24/7 dedicated support team</span>
                    </div>
                    <div className="flex items-center space-x-3">
