...
export default function Home() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="fixed inset-0 bg-gradient-to-br from-slate-900 via-gray-900 to-black dark:from-slate-950 dark:via-gray-950 dark:to-black">
        {/* Subtle tech pattern overlay */}
        <div className="absolute inset-0 opacity-20 dark:opacity-30 bg-[url('/images/security-pattern.png')] bg-repeat bg-[length:200px_200px]" />
