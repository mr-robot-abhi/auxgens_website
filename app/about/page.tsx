        ...
        <main className="pt-32 pb-20">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-16">
              <h1 className="text-4xl sm:text-5xl font-bold text-white mb-6">About Auxgens</h1>
            ...
            {/* Company Overview */}
            <div className="mb-20">
              <div className="bg-gray-900/60 backdrop-blur-sm p-12 rounded-2xl shadow-lg border border-gray-700/50">
                <h2 className="text-3xl font-bold text-white text-center mb-8">Who We Are</h2>
            ...
            <div className="grid md:grid-cols-2 gap-12 mb-20">
              <div className="bg-gray-900/60 backdrop-blur-sm p-8 rounded-xl shadow-lg border border-gray-700/50">
            ...
            <div className="mb-20">
              <div className="bg-gradient-to-br from-green-500/10 to-blue-500/10 backdrop-blur-sm p-12 rounded-2xl border border-green-500/20">
                <h2 className="text-3xl font-bold text-white text-center mb-8">Industry Experience</h2>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                  {[
                    ...
                    <div
                      key={index}
                      className="bg-gray-800/60 backdrop-blur-sm p-4 rounded-lg text-center border border-gray-700/50"
                    >
            ...
            {/* Why Choose Us */}
            <div className="bg-gradient-to-br from-green-500/10 to-blue-500/10 backdrop-blur-sm p-12 rounded-2xl border border-green-500/20">
              <h2 className="text-3xl font-bold text-white text-center mb-12">Why Choose Auxgens?</h2>
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-green-400 rounded-full mt-3 flex-shrink-0"></div>
                    <div>
                      <h3 className="font-bold text-white mb-2">Comprehensive Solutions</h3>
                      <p className="text-gray-300">
                  ...
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-green-400 rounded-full mt-3 flex-shrink-0"></div>
                    <div>
                      <h3 className="font-bold text-white mb-2">Scalable Services</h3>
                      <p className="text-gray-300">
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-green-400 rounded-full mt-3 flex-shrink-0"></div>
                    <div>
                      <h3 className="font-bold text-white mb-2">Cutting-edge Technology</h3>
                      <p className="text-gray-300">
                  ...
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-green-400 rounded-full mt-3 flex-shrink-0"></div>
                    <div>
                      <h3 className="font-bold text-white mb-2">Proven Track Record</h3>
                      <p className="text-gray-300">
                  ...
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-green-400 rounded-full mt-3 flex-shrink-0"></div>
                    <div>
                      <h3 className="font-bold text-white mb-2">Cost-effective Solutions</h3>
                      <p className="text-gray-300">
